...
export default Security = ({navigation}) => {
    return(
        <View>
            <TouchableOpacity style={{justifyContent:'space-between', width:'90%', flexDirection: 'row', paddingTop: 60, borderBottomColor: '#8D8D8D', borderBottomWidth: 1, marginLeft: 25, paddingBottom: 20}} onPress={()=> navigation.navigate('Change password')} >
            ...
            <TouchableOpacity style={{justifyContent:'space-between', width:'90%', flexDirection: 'row', paddingTop: 30, borderBottomColor: '#8D8D8D', borderBottomWidth: 1, marginLeft: 25, paddingBottom: 20}} onPress={()=> navigation.navigate("Manage Devices")}>
                <View style={{paddingLeft: 10}}>
